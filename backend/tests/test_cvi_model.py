...
def test_predict_cvi_insufficient_data():
...
def test_predict_cvi_missing_fields():
    """Missing cycle_length should default to 28, leading to zero variance."""
    logs = [{}, {}, {}]
    assert predict_cvi(logs) == 30.0

def test_predict_cvi_known_variance():
...
def test_predict_cvi_uses_latest_logs():
